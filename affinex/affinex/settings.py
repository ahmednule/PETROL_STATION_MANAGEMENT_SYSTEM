"""
Django settings for affinex project.
...
SECRET_KEY = 'django-insecure-pkcd@=u#13&lg=ue2-cafg!%9jgm-ob3iv!^^3np3*s38&2q4y'
...
WSGI_APPLICATION = 'affinex.wsgi.application'
